...
void CalcRotation(aiQuaternion& Out, float AnimationTime, const aiNodeAnim* pNodeAnim)
{
	AnimationTime;
...
void CalcScaling(aiVector3D& Out, float AnimationTime, const aiNodeAnim* pNodeAnim)
{
	AnimationTime;
...
void CalcPosition(aiVector3D& Out, float AnimationTime, const aiNodeAnim* pNodeAnim)
{
...
void CalcInterpolatedPosition(aiVector3D& Out, float AnimationTime, const aiNodeAnim* pNodeAnim)
{
	...
	float DeltaTime = (float)pNodeAnim->mPositionKeys[NextPositionIndex].mTime - (float)pNodeAnim->mPositionKeys[PositionIndex].mTime;
...
const aiNodeAnim* FindNodeAnim(const aiAnimation* pAnimation, const aiString& nodeName)
{
	...
	{
		if (strcmp(pAnimation->mChannels[i]->mNodeName.C_Str(), nodeName.data) == 0)
		{
