...
namespace Collision
{
	static bool Intersects(const Collider& LhsCollider, const Collider& RhsCollider)
	{
		...
		{
			return Intersects(dynamic_cast<const CircleCollider&>(LhsCollider), dynamic_cast<const CircleCollider&>(RhsCollider));
		}
	...
	static bool Intersects(const CircleCollider& LhsCollider, const CircleCollider& RhsCollider)
	{
